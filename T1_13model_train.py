...
OUTPUT_NAME = "A1.csv"
SUMMARY_NAME = "summary_v33_multithread_hashseed0.json"
META_MAX_ITER = 5000
...
def train_base_models_v10(
    ...
    """
    V9 基线模型池，原样继承自线上 0.7761 notebook。
...
def main():
    print("=" * 80)
    print("  V33: V31 Multi-thread + In-code PYTHONHASHSEED=0")
    ...
    print("\n[Feature Engineering V3 - Structural]")
    ...
    print("\n[Training Base Models - KFold OOF V10]")
    ...
    for fold, (tr_loc, va_loc) in enumerate(
        ...
        fold_probs = train_base_models_v10(
            x_model=x_model,
            x_knn=x_knn,
            x_sparse=x_sparse,
            adj_norm=adj_norm,
    ...
    summary = {
        "version": "v33_v31_multithread_hashseed0",
        "base_version": "v31_v27_drop_lr01_exposure",
        "determinism": {
        ...
        "v27_ablation": {
            ...
            "selection_source": "V26 leave-one-out plus 10-30% test-like stability audit",
        },
        "v31_ablation_inherited": {
            ...
            "selection_source": "V30 conditional full-model ablation with relaxed tiny-decline tolerance",
        },
        "added_from_v10": {
            "added_models": [
                "sridge30"
        ...
        "pruned_from_v9": {
            ...
            "reason": "Reduce meta-stacker overfitting and keep only models with non-trivial v9 blend contribution, plus sparse ridge for original sparse feature complementarity."
        }
    }
